...
public class RedisUtils {
	...
	public RedisUtils(String ip, int prot) {
		if (pool == null) {
			...
			config.setMaxWaitMillis(200 * 100);
	 ...
	 * @return
	 */
	public Long sadd(String key, Map<String, Double> scoreMembers) {
		Jedis jedis = null;
		Long res = null;
		try {
			jedis = pool.getResource();
...
/*	public static void main(String[] args){
		RedisUtils red = new RedisUtils("localhost",6379);
		
		red.set("canjie", "123456");
	}*/
}